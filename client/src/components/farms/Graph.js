        ...
        <ScrollView style={styles.mainContainer}>
          <View style={styles.container}>
            <Card
              ...
              <RecommendedCard recommended="Nilai Normal yang dianjurkan = 40-60 %" warning="Nilai Diatas 60 % = Basah" danger="Nilai Dibawah 40 % = Sangat Kering"/>
        ...
        <ScrollView style={styles.mainContainer}>
          <View style={styles.container}>
            <Card
              ...
              <RecommendedCard recommended="Nilai Normal yang dianjurkan = 50% -80%" warning="Nilai Diatas 80 % = Sangat Basah" danger="Nilai Dibawah 35% = Sangat Kering"/>
              <Text style={{marginBottom: 10}}>
        ...
        <ScrollView style={styles.mainContainer}>
          <View style={styles.container}>
            <Card
              ...
              <RecommendedCard recommended="Nilai Normal yang dianjurkan = 24-30 °C" warning="Nilai Diatas 31°C = Panas" danger="Nilai Dibawah 22°C = Dingin"/>
              <Text style={{marginBottom: 10}}>
      ...
      <ScrollView style={styles.mainContainer}>
          <View style={styles.container}>
            <Card
              ...
              <RecommendedCard recommended="Nilai Normal yang dianjurkan = 20-30 cm" warning="Nilai Dibawah 20 cm reservoir harus sudah diisi" danger="Nilai dibawah 10 cm tidak dapat menyiram"/>
              <Text style={{marginBottom: 10}}>
